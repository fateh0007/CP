        ...
        if (!moved) {
            ...
            for (int i = 0; i < ff; ++i) {
                if (ball_x >= ramps[i].min_x && ball_x <= ramps[i].max_x) {
                    ...
                    if (ramps[i].slope_type == 1)
                        intersection_y = ball_x + ramps[i].intercept;
                    else if (ramps[i].slope_type == -1)
                        intersection_y = ramps[i].intercept - ball_x;
